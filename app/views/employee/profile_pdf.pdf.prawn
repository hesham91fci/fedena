...
pdf.image StringIO.new(@student.photo_data)
...
pdf.move_down(100)
pdf.text @employee.full_name , :size => 17 ,:at=>[0,625]
pdf.fill_color "736F6E"
pdf.text "Employee Profile(General)" ,:size => 9,:at=>[0,610]
...
data= [ 
        ...
        ["Grade", @employee.employee_grade.name],
...
pdf.table data, :width => 540,
    ...
    pdf.text @employee.full_name , :size => 17 ,:at=>[0,625]
    pdf.fill_color "736F6E"
    pdf.text "Employee Profile(Personal)" ,:size => 9,:at=>[0,610]
    pdf.fill_color "000000"
    pdf.move_down(20)
...
pdf.table data, :width => 540,
    ...
    pdf.text @employee.full_name , :size => 17 ,:at=>[0,625]
    pdf.fill_color "736F6E"
    pdf.text "Employee Profile(Address details)" ,:size => 9,:at=>[0,610]
    pdf.fill_color "000000"
    pdf.move_down(20)
...
pdf.text @employee.full_name , :size => 17 ,:at=>[0,625]
pdf.fill_color "736F6E"
pdf.text "Employee Profile(Contact details)" ,:size => 9,:at=>[0,610]
pdf.fill_color "000000"
pdf.move_down(20)
...
pdf.text @employee.full_name , :size => 17 ,:at=>[0,625]
pdf.fill_color "736F6E"
pdf.text "Employee Profile(Bank Account Details)" ,:size => 9,:at=>[0,610]
pdf.fill_color "000000"
pdf.move_down(20)
...
pdf.text @employee.full_name , :size => 17 ,:at=>[0,625]
pdf.fill_color "736F6E"
pdf.text "Employee Profile(Additional Details)" ,:size => 9,:at=>[0,610]
pdf.fill_color "000000"
pdf.move_down(20)
