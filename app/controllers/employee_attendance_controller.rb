...
#    prawnto :prawn => {:left_margin => 25, :right_margin => 25}
    ...
    def leave_reset_settings
        ...
        if request.post?
            ...
            flash[:notice] = 'Natavení bylo úspěšně uloženo'
        end
    end
    ...
    def update_employee_leave_reset_all
        ...
        render :update do |page|
            page.replace_html "reset-box", :text => "Počitadlo dovolených bylo úspěčně resetováno pro všechny zaměstnance"
        end
    end
    ...
    def employee_wise_leave_reset
        ...
        render :update do |page|
            flash.now[:notice]="Reset Dovolené bylo úspěšné"
    ...
    def approve_leave
        ...
        flash[:notice]="Dovolená je schválena pro #{@applied_employee.first_name} od #{@applied_leave.start_date} to #{@applied_leave.end_date}"
    ...
    def deny_leave
        ...
        flash[:notice]="Dovolená zamítnuta pro #{@applied_employee.first_name} od #{@applied_leave.start_date} to #{@applied_leave.end_date}"
    ...
    def cancel_application
        ...
        flash[:notice] = "Aplikace Dovolená byla vymazána"
        else
        flash[:notice] = "Omlouvám se schválení dovolené nemůže být vymazáno"
        end
